...
<div class="wrapper">
  ...
  <div class="license" id="sro-stroiteli-urala">
    ...
    <div class="license__link-inner">
      <i class="fa fa-file-pdf-o license__icon"></i><a class="link" target="_blank" href="/img/licenses/smr-220317-pdf.pdf">Смотреть в PDF</a>
    </div>
  </div>
  <div class="license" id="sro-project-work">
    ...
    <div class="license__link-inner">
      <i class="fa fa-file-pdf-o license__icon"></i><a class="link" target="_blank" href="/img/licenses/project-work-pdf.pdf">Смотреть в PDF</a>
    </div>
  </div>
</div>
