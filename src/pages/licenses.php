...
<div class="wrapper">
  ...
  <div class="license" id="mchs">
    ...
    <div class="license__wrap">
      <img class="license__img" src="/img/licenses/mchs-1.jpg" alt="">
    </div>
    <a class="link license__link" target="_blank" href="/img/licenses/mchs-pdf.pdf">Смотреть в PDF</a>
  </div>
  <div class="license" id="sro-stroiteli-urala">
    ...
    <div class="license__wrap">
      <img class="license__img" src="/img/licenses/smr-220317-0.jpg" alt="">
    </div>
    <a class="link license__link" target="_blank" href="/img/licenses/smr-220317-pdf.pdf">Смотреть в PDF</a>
  </div>
  <div class="license" id="sro-project-work">
    <h2 class="title title-h2">СРО на проектные работы</h2>
    <div class="license__wrap">
      <img class="license__img" src="/img/licenses/project-work-0.jpg" alt="">
    </div>
