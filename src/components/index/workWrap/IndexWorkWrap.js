...
function IndexWorkWrap() {
  return (
    <IndexWorkWrapDiv>
      <IndexWork
        src="/img/index/civil_engineering.jpg"
        alt="Комплексное промышленное и гражданское строительство"
        text="Комплексное промышленное и гражданское строительство"
      />
      <IndexWork
        src="/img/index/drawing_project.jpg"
        alt="Проектирование"
        text="Проектирование"
      />
      <IndexWork
      ...
      />
      <IndexWork
        src="/img/index/service.png"
        alt="Гарантийное и постгарантийное техническое обслуживание"
        text="Гарантийное и постгарантийное техническое обслуживание"
      />
    </IndexWorkWrapDiv>
  );
}
