  ...
  render() {
    return (
      <IndexWorkWrapDiv>
        ...
        <IndexWork src="/img/index/ventilation_installation.jpg" alt="Монтаж оборудования" text="Поставка, монтаж и пуско-наладка всего необходимого оборудования для систем водоснабжения
